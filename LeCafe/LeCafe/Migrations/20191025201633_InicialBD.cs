        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cajeroId = table.Column<string>(nullable: true),
                    nombre = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orden_AspNetUsers_cajeroId",
                        column: x => x.cajeroId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_Orden_ordenId",
                        column: x => x.ordenId,
                        principalTable: "Orden",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItem_Productos_productoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItem_ordenId",
                table: "OrderItem",
                column: "ordenId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItem_productoId",
                table: "OrderItem",
                column: "productoId");
        }
